...
public:
    ...
    void setScoreLimit(uint32_t limit) { scoreLimit = limit; }
    ...
    void setRoundScore(uint32_t score) { roundScore = score; }
    void increaseRoundScore(uint32_t score) { roundScore += score; }
